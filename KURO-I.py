"""
Author  : Based on original KURO-I by Varong B.

#Python libs req:
>> pip install requests telegram python-telegram-bot watchdog

#fail2ban setup:
>> vi /etc/fail2ban/jail.d/ai-apache.local.conf
    [ai-apache]
    enabled = true
    backend = polling
    filter = ai-apache
...
LOGFILE = "/opt/en_log/ssl_access_log"
AUDIT_LOG = "/opt/en_log/AI_audit.log"
BAN_LOG = "/opt/en_log/AI_ban_history.jsonl"
...
WHITELIST_NETWORKS = [
    "127.0.0.0/8",
    "10.0.0.0/8",                 # For MU's VPN, later fix
    "10.14.0.0/16"                # Faculty IP ranges
]
